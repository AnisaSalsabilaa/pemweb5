...
<body>
	...
	if (empty($_POST['nama'])) { // Melakukan seleksi looping
		header("Location: tugas1kosong.php"); // Jika tidak ada nama yang diinputkan maka akan menuju form tugas1kosong.php
	} else if (empty($_POST['email'])) { // Melakukan seleksi looping
		header("Location: tugas1kosong.php"); // Jika tidak ada email yang diinputkan maka akan menuju form tugas1kosong.php
