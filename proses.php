...
if ($angka==100){ // Melakukan seleksi looping 
	...
	echo "Sangat Baik"; // Menampilkan teks Sangat Baik jika nilai <100 && nilai >=85
} elseif ($angka<85&&$angka>=70){ // Melakukan seleksi looping
	echo "Baik"; // Menampilkan teks Baik jika nilai <85 && nilai >=70
} elseif ($angka<70&&$angka>=55){ // Melakukan seleksi looping
	echo "Cukup"; // Menampilkan teks Cukup jika <70 && nilai >=55
} elseif ($angka<55&&$angka>=0){  // Melakukan seleksi looping 
	echo "Kurang"; // Menampilkan teks Kurang jika <55 && nilai >=0
}
?>